        ...
        { flake-utils , self } :
          ...
          (
		    ...
		    input :
			      ...
			      # if is-simple then 1 else if is-list then builtins.foldl' reducers.foldl' reducers.size 0 input else builtins.foldl' reducers.size 0 ( builtins.attrNames input ) ;
                              track =
                                {
                                  caller = caller ;
                                  index = index ;
