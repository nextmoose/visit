                            ...
                            let
                              ...
                              qualified-name =
                                let
                                  mapper =
                                    element :
                                      if builtins.typeOf element == "int" then "[ ${ builtins.toString element } ]"
                                      else if builtins.typeOf element == "string" then "{ ${ element } }"
                                      else builtins.throw "89a28d8a-12eb-41b1-8f7a-0f9e3a5aca44" ;
                                  strings = builtins.map mapper path ;
                                  in builtins.concatStringsSep " " strings ;
                              ...
                              simple-name =
                                let
                                  elem = builtins.elemAt path ( length - 1 ) ;
                                  length = builtins.length path ;
                                  in builtins.toString elem ;
                              track =
                                {
                                  caller = caller ;
                                  functions = functions ;
