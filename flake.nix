                              ...
                              reducers =
                                {
                                  ...
                                  size = previous : current : if is-simple then 1 else if is-list then previous + ( builtins.trace "LIST" current.size ) else previous + ( builtins.trace "SET" current.size ) ;
                                } ;
