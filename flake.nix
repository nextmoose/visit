                        ...
                        caller =
                          index : path : input :
                            let
                              ...
                              processed =
                                let
                                  indices = if is-simple then builtins.trace "IS-SIMPLE" [ ] else if is-list then builtins.trace "IS-LIST" ( builtins.genList ( x : x ) ( builtins.length input ) ) else builtins.trace "IS-SET" ( builtins.attrNames input ) ;
