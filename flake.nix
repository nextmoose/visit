            ...
            system :
              {
                lib =
				  ...
				  in builtins.trace "YES: ${ builtins.concatStringsSep " , " ( builtins.attrValues ( builtins.foldl' reducers.processed initial list ) ) }" ( builtins.foldl' reducers.processed initial list ) ;
                              reducers =
                                {      
                                  processed =
                                    previous : current :
