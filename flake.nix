                              ...
                              reducers =
                                {
                                  ...
                                  size = previous : current : previous + ( builtins.trace "${ builtins.typeOf current } ${ if is-simple then "is-simple" else "not-is-simple" } ${ if is-list then "is-list" else "not-is-list" }" current.size ) ;
                                } ;
