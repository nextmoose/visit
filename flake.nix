                ...
                lib =
                  {
                    ...
                    value :
                      let
                        functions =
                          {
                            find = fun : builtins.head ( builtins.filter ( f : builtins.typeOf f == "lambda" ) [ fun undefined ( x : x.processed ) ] ) ;
                          } ;
                        mappers =
                          {
                           list =
				        ...
				        track.type
                                        {
                                          ...
                                          int = int ;
                                          lambda = lambda ;
                                          list = ( track : builtins.typeOf track ) ;
                                          null = null ;
                                          path = path ;
                                          set = set ;
                                          string = string ;
                                  ...
                                  output = track : builtins.trace "${ builtins.typeOf ( track.lambda-output track ) }" ( track.lambda-output track ) ;
