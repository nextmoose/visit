                                  ...
                                  processed =
                                    previous : current :
                                      let
                                        ...
                                        in if is-simple then next else if is-list then builtins.concatLists [ previous [ next ] ] else previous // { "${ current }" = builtins.trace ( builtins.typeOf ( index + last ) ) next ; } ;
